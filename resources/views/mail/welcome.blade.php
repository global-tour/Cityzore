...
<body>
    ...
    <div class="col-lg-12">
        <h3>{{$data['name']}} {{$data['surname']}}, welcome to Cityzore</h3>
        <br>
        <h3>You can explore the world now. Tours are just one click away!</h3>
        <br>
        <p>You can use this coupon code to book any tour you want
            @if ($data['couponDiscountType'] == 'percent')
            %{{$data['couponDiscount']}}
            @else
            €{{$data['couponDiscount']}}
            @endif
        ...
        <br>
        <p>You can only use this coupon one time. This coupon is valid for 1 week.</p>
    </div>
