...
<div class="col-lg-12">
    <h3>Hello,</h3>
    <h3>You can click the link below to type R-Codes of your restaurant.</h3>
    <br>
    <a href="https://supplier.cityzore.com/bookings-restaurant/{{$data['refCode']}}/{{$data['hash']}}">R-Codes for Cityzore</a>
    <!-- Href link will be changed to https://cityzore.com/bookings-restaurant/{hash} -->
</div>
