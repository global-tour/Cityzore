                    ...
                    <table style="max-width:600px;text-align:left">
                        <tbody>
                            ...
                            <tr>
                                <td style="padding:12px 0 0;text-align:center" align="center">
                                    <p style="color:hsl(0,0%,24%);font-size:18px;font-family:BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:bold;line-height:22.5px;margin:0">
                                        {{$data['commissionerName']}} {{$data['commissionerSurname']}} shared a cart with you.
                                    </p>
                                </td>
                            </tr>
                            @foreach($data['cartDetails'] as $cd)
                                <tr>
                                    <td>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td style="padding:30px 18px 0">
                                                        <p style="margin:0;padding:0">
                                                            Reference Number: {{$cd['referenceCode']}}
                                                        </p>
                                                        <p style="color:hsl(0,0%,34%)!important;font-family:BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:1.5em;margin:10px 0 0;padding:0">
                                                            Title: {{$cd['productTitle']}}
                                                        </p>
                                                        <p>
                                                            Info: {{$cd['categoryAndCountInfo']}}
                                                        </p>
                                                        <p style="font-size:14px;margin:8px 0 0 0;padding:0">
                                                            Subtotal: {{$data['currencySymbol']}} {{$cd['subTotal']}}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                            ...
                            <tr>
                                <td style="padding:12px 0 0;text-align:center" align="center">
                                    <p style="color:hsl(0,0%,24%);font-size:18px;font-family:BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:bold;line-height:22.5px;margin:0">
                                        Total: {{$data['currencySymbol']}} {{$data['total']}}
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:50px 18px 0">
                                    <div style="margin:0;padding:0;text-align:center">
                                        <a style="background:hsl(348,78%,98%);border:2px solid hsl(348,48%,96%);border-radius:4px;color:hsl(348,78%,56%);display:block;font-size:14px;font-weight:bold;line-height:22.5px;text-decoration:none;font-family:BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;padding:12px" href="{{$data['paymentLink']}}" target="_blank">
                                            Please click this link to finalize your payment
                                        </a>
                                    </div>
                                </td>
                            </tr>
