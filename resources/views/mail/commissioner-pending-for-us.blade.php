...
<head>
    ...
    <title>Cityzore-Agency Pending</title>
    <style>
        body {
            margin-right: 15%;
            margin-left: 15%;
...
<div class="col-lg-12">
    <p>We received a request to be an agency. It is pending right now.</p>
    <p>You can activate their agency status on <a href="https://admin.cityzore.com/commissioners" target="_blank">Cityzore Admin Panel</a></p>
    <br>
    <u>More Information</u>
    <p>Company Name  : {{$data['companyName']}}</p>
    <p>Phone         : {{$data['countryCode']}}{{$data['phoneNumber']}}</p>
    <p>Company E-Mail: {{$data['companyEmail']}}</p>
</div>
