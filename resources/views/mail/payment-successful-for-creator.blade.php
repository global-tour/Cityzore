...
<head>
    ...
    <!-- GOOGLE FONTS -->
    <title>Cityzore-Payment is Successful</title>
    <style>
        body {
            margin-right: 15%;
            margin-left: 15%;
...
<body>
    ...
    <div class="col-lg-12">
        <h3>Payment is successfully made.</h3>
        <br>
        <h4>Payment Details: </h4>
        <p>E-Mail: {{$data['payment_email']}}</p>
        <p>Price: {{$data['payment_price']}}</p>
        <p>Message: {{$data['payment_message']}}</p>
        <p>Reference Code: {{$data['payment_reference_code']}}</p>
    </div>
