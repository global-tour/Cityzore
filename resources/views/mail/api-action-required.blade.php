...
<head>
    ...
    <!-- GOOGLE FONTS -->
    <title>Cityzore-Action Required</title>
    <style>
        body {
            margin-right: 15%;
            margin-left: 15%;
...
<div class="col-lg-12">
    <h3>We receive a cancel request from GetYourGuide.</h3>
    <h3>This datetime is disabled after the reservation is made.</h3>
    <h3>Hence the disabled date and time below is reopened automatically. You may disable it again.</h3>
    <p>
        <strong>Option Title:</strong> {{$data['optionTitle']}}
    </p>
    <p>
        <strong>Option Reference Code:</strong> {{$data['optionReferenceCode']}}
    </p>
    <p>
        <strong>Date and Time:</strong> {{$data['date']}} {{$data['time']}}
    </p>
</div>
