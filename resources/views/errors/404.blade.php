            ...
            <div class="container">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8" style="margin-right: 15%;margin-left: 15%;">
                        <form method="POST" multiple action="{{route('mail.contact404')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="message" class="form-control" id="text" placeholder="Your Message" style="height: 100px;">
                            </div>
