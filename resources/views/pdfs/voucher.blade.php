                    ...
                    @elseif($ticketType == '7')
                        @for($i=0; $i<$participantSum; $i++)
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td style="font-weight: bold;font-size: 12px;">À savoir</td>
                                </tr>
                                <tr>
                                    <td class="margin" style="font-size: 11px;">
                                        - Horaires de visite => Le Palais Garnier est ouvert et accessible à la visite : <br>
                                        - de 10 h à 17 h (accès jusqu’à 16h30) de début septembre à mi-juillet <br>
                                        - Le Palais Garnier sera ouvert de 10h à 18h (dernier accueil des visiteurs à 17h00) du 22 juin au 6 septembre 2020. <br>
                                        - Sauf jours de représentations et de fermetures exceptionnelles (avant votre visite, consultez le site operadeparis.fr). <br>
                                        - Vendu à l'avance - ni repris, ni échangé <br>
                                        - Ce billet est valable un jour et uniquement pour une entrée à la date sélectionnée <br>
                                        - L’accès à la salle de spectacle peut être restreint ou rendu impossible pour des raisons techniques et/ou artistiques. <br>
                                        - Il est obligatoire à partir de 11 ans, de porter un masque tout au long de la visite. <br>
                                        - Les vestiaires sont fermés pendant les heures de visite. Il n’est pas possible d’entrer avec une poussette, une trottinette ou tout autre bagage volumineux.
                                    </td>
                                </tr>
                            </table>
                            <table style="width:100%;">
                            ...
                            <tr>
                                @for($i=0; $i<$participantSum; $i++)
                                    <th>
                                        ...
                                        <div style="position:absolute; top:47px; padding-left: 15px; font-weight: normal;font-size: 10px;">Numéro de réservation </div>
