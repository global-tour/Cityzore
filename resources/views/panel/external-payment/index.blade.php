...
<div class="sb2-2-add-blog sb2-2-1">
    ...
    <div class="bor">
        <div class="row" style="margin-top: 50px">
            <table id="external-payment" class="table table-striped table-hover" style="width: 100%"></table>
            ...
            {{--                            <td>--}}
{{--                                            <button data-id="{{$paymentLink->id}}" class="btn btn-xs btn-primary btn-block resendEmail" style="width: 120px; padding: 0px;margin-bottom: 3px; color: black; background-color: transparent; border-color: #8852E4; font-size: 10px; font-weight: bold;">Re-send Email</button>--}}
{{--                                            @if($paymentLink->is_paid == 1)--}}
...
<div class="modal fade" id="externalPaymentModal" role="dialog">
