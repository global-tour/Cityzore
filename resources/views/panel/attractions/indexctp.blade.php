@include('panel-partials.head', ['page' => 'attraction-indexctp'])
@include('panel-partials.header', ['page' => 'attraction-indexctp'])
...
@include('panel-partials.scripts', ['page' => 'attraction-indexctp'])
@include('panel-partials.datatable-scripts', ['page' => 'attraction-indexctp'])
