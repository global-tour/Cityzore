@include('panel-partials.head', ['page' => 'attraction-indexpct'])
@include('panel-partials.header', ['page' => 'attraction-indexpct'])
...
@include('panel-partials.scripts', ['page' => 'attraction-indexpct'])
@include('panel-partials.datatable-scripts', ['page' => 'attraction-indexpct'])
