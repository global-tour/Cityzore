@include('panel-partials.head', ['page' => 'attraction-index'])
@include('panel-partials.header', ['page' => 'attraction-index'])
...
@include('panel-partials.scripts', ['page' => 'attraction-index'])
@include('panel-partials.datatable-scripts', ['page' => 'attraction-index'])
