...
<script>
    $(function() {
        $('body').on('click', '.addTier', function() {
            ...
            block +=
                ...
                '    </div>\n' +
                '    <div class="input-field col-md-1 s1">\n' +
                '        <input id="price'+it+'" min="0" name="price'+it+'" type="number" onkeyup="calculateComission(\'price'+it+'\', $(this));" step="any" class="validate form-control price">\n' +
    ...
    function isMinMaxAgesValid() {
        ...
        console.log(findDuplicates(sortedAgesArr).length);
        console.log('ages');
        console.log(agesArr);
        console.log('sorted');
        console.log(sortedAgesArr);
