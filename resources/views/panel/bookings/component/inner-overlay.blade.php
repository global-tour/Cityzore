...
<div class="offcanvas-body">
    ...
    <div class="tab-content">
            ...
            <form id="bookingDetailsForm" data-submit="{{ url('/update-booking-detail') }}">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        <label for="number" class="{{ !is_null($booking->totalPrice) ? 'active' : '' }}">Price</label>
                    </div>
                </div>
        ...
        <div id="invoice" class="tab-pane fade {{ !is_null($attr) && $attr == '#invoice' ? 'active in' : '' }}">
                        ...
                        <table class="table-bordered">
                            ...
                            @foreach($booking->invoice_numbers as $invoice)
                                ...
                                <tr>
                                    ...
                                    <td width="60">
                                        <a href="#" class="btn-clean btn-icon" style="text-align: center" onclick="console.log($(this).find('form').submit())">
            ...
            <form data-submit="{{ url('import-invoice-number') }}" style="margin-top: 20px" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <input type="hidden" name="booking_id" value="{{ $booking->id }}">
                    <div class="input-field col s12">
                    ...
                    <div class="invoice-wrapper">
                        ...
                        <div class="input-field col s12" style="display: none">
                            <input type="file" name="invoice_file" style="border-bottom: 1px solid #9e9e9e; padding-bottom: 15px; width: 100%;">
                        </div>
