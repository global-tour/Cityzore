...
{{--        <a href="{{url('/blog')}}" class="btn btn-default pull-right" style="margin-left: 10px;">Switch To CZ</a>--}}
        <select name="" id="" class="" style="width: 200px; display: inline-block; float: right; border: 1px solid; height: 37px;" onchange="window.location.href = this.value">
            ...
            <option value="/blogCTP" selected>Citytours.paris</option>
        </select>
            ...
            @foreach($blogPosts as $blogPost)
                <tr>
                  ...
                  <td>
                    ...
                    <td>
                        <a href="{{url('/blog/'.$blogPost->id.'/editCTP')}}" class="sb2-2-1-edit"><i class="icon-cz-edit" aria-hidden="true"></i></a>&nbsp;
                        <a href="{{url('/blog/'.$blogPost->id.'/deleteCTP')}}" class="sb2-2-1-edit"><i class="icon-cz-trash" aria-hidden="true"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
...
@include('panel-partials.scripts', ['page' => 'blog-index-ctp'])
@include('panel-partials.datatable-scripts', ['page' => 'blog-index-ctp'])
