@include('panel-partials.head', ['page' => 'product-indexctp'])
@include('panel-partials.header', ['page' => 'product-indexctp'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-inn-sp">
                <input type="hidden" id="productType" value="productCTP">
                <div class="inn-title">
                    <h4>All Products</h4>
...
{{--                    <a href="{{url('/switchToPCT?route=productcz')}}" class="btn btn-default pull-right" style="margin-left: 10px;">Switch To CZ</a>--}}
                        <select name="" id="" class="" style="width: 200px; display: inline-block; float: right; border: 1px solid; height: 37px;" onchange="window.location.href = this.value">
                            ...
                            <option value="/productCTP" selected>Citytours.paris</option>
                        </select>
                    @endif
                </div>
...
@include('panel-partials.scripts', ['page' => 'product-indexctp'])
@include('panel-partials.datatable-scripts', ['page' => 'product-indexctp'])
