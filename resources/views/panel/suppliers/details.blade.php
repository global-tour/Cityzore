            ...
            <div class="box-inn-sp">
                ...
                <div class="tab-inn">
                    ...
                    <div class="tab-inn">
                        ...
                        <div>
                            <form enctype="multipart/form-data" method="POST" action="{{url(auth()->guard('supplier')->user()->id.'/licenseSave')}}" id="filesTable">
                                @csrf
                        ...
                        <table class="responsive-table">
                            ...
                            <tbody>
                            @foreach(\App\LicenseFile::where('companyID', Auth::guard('supplier')->user()->id)->get() as $l)
                                <tr id="{{$l->id}}">
                                    <td>{{$l->title}}</td>
                                    <td>{{$l->fileName}}</td>
                                    <td>
