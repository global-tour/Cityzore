            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="wed-logo">
                        ...
                        <form method="GET" class="tourz-search-form tour-form-one hidden-xs hidden-sm" action="{{url($langCodeForUrl.'/s')}}" autocomplete="off" style="width: 60%;">
                            <div class="input-field" style="margin-top: 0!important;padding-top:4px!important;">
                            ...
                            <div class="input-field" style="margin-top: 0!important;padding-top:4px!important;width: 10%;">
