!function (t, e) {
        ...
        init: function () {
            ...
            binding: function () {
                ...
                onKeyDown: function (t) {
                    var e = this.DOM.dropdown.querySelector("." + this.settings.classNames.dropdownItemActive), i = e;
                    switch (t.key) {
                        case"ArrowDown":
                        case"ArrowUp":
                        case"Down":
                        ...
                        case"Tab":
                            if ("mix" != this.settings.mode && i && !this.settings.autoComplete.rightKey && !this.state.editing) {
                                t.preventDefault();
                                var a = i.getAttribute("tagifySuggestionIdx"), n = a ? this.suggestedListItems[+a] : "";
    ...
    var p = {
        customBinding: function () {
            ...
            onFocusBlur: function (t) {
                ...
                var e, i, s, a, n, o, r, l, c = this, g = this.settings, u = this.value.length, p = this.getTagElms(),
                ...
                var s = t.closest("." + this.settings.classNames.tag), a = this.getNodeIndex(s), n = this.tagData(s),
    ...
    return f.prototype = {
            ...
            set: function () {
                ...
                suggest: function (t) {
                    if (this.settings.autoComplete.enabled) {
                        ...
                        var e = t.value ? "" + t.value : "", i = e.substr(0, this.state.inputText.length).toLowerCase(),
        ...
        addTags: function (t, e) {
            var i = this,
                s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.settings.skipInvalid, a = [],
                n = this.settings;
        ...
        addMixTags: function (t) {
            ...
            if (t[0].prefix || this.state.tag) this.prefixedTextToTag(t[0]); else {
                ...
                var i = !!this.state.selection, s = document.createDocumentFragment();
