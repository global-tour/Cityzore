...
$(document).ready(function () {
    ...
    }), $("#status").fadeOut(), $("#preloader").delay(350).fadeOut("slow"), $("body").delay(350).css({overflow: "visible"}), $('select:not(.shaselect)').material_select(), $(".slider").slider(), $("#select-city,#select-city-1,#select-city-2,#select-city-3,#select-city-4,#select-city-5.autocomplete").autocomplete({
        data: {
            "New York": null,
            California: null,
            Illinois: null,
